...
# Optional: token/alt URLs for private repo
...
# Add GitHub host keys so SSH clone won't prompt
...
# Clean legacy location if any
rm -rf "$HOME/.emacs.d"

# Private Doom repo (SSH first, HTTPS+token fallback)
